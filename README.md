...
If there is new major version release, then follow Wazuh [docs for Docker](https://documentation.wazuh.com/current/deployment-options/docker/wazuh-container.html)
